 ...
 * Build: http://modernizr.com/download/#-applicationcache-canvas-canvastext-draganddrop-hashchange-history-audio-video-indexeddb-input-inputtypes-localstorage-postmessage-sessionstorage-websockets-websqldatabase-webworkers-shiv-cssclasses-hasevent-domprefixes-load
 */;
window.Modernizr = function (a, b, c) {
   ...
   !B(x, "undefined") && !B(x.call, "undefined") ? y = function (a, b) {
      ...
      return !!testPropsAll("indexedDB", a)
   ...
   for(var F in q) y(q, F) && (v = F.toLowerCase(), e[v] = q[F](), t.push((e[v] ? "" : "no-") + v));
   ...
   function (a, b) {
      ...
      a.html5 = r, q(b)
   }(this, b), e._version = d, e._domPrefixes = p, e._cssomPrefixes = o, e.hasEvent = w, g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (f ? " js " + t.join(" ") : ""), e
}(this, this.document),
function (a, b, c) {
   function d(a) {
