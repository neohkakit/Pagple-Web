      ...
      return this.each(function () {
        ...
        if (!data) {
          ...
          if (options.hideOnHTMLClick) {
            ...
            if ("ontouchstart" in document.documentElement) hideEvent = 'touchstart.popover';
